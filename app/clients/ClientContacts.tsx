  ...
  return (
    <div className="p-3 sm:p-0">
      <div className="p-4 sm:p-5" style={ui.cardStyle}>
        <SectionHeader
          title="Contacts"
          subtitle="Gestion des contacts client (CRUD)"
          right={
        ...
        {!loading && filtered.length === 0 ? <div className="mt-4 text-sm opacity-80">Aucun contact.</div> : null}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div>
                  ...
                  <div className="mt-1 text-sm opacity-80">
                    {c.fonction ?? '—'} · {c.email ?? '—'} · {c.telephone ?? '—'}
                  </div>
                  {c.notes ? <div className="mt-2 text-sm opacity-80">{c.notes}</div> : null}
                </div>
        ...
        {edit ? (
          <div className="mt-5 p-4" style={{ border: `1px solid ${ui.c.border}`, borderRadius: 16 }}>
